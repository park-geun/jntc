...
$(document).ready(function () {
     ...
     $('#cover-glass .swiper-slide').hover(function () {
        ...
        glassImg.attr('style', 'background-image:url(/en/resources/images/intro-phone-' + idx + '.jpg)');
        ...
        glassImg.attr('style', ' background-image:url(/en/resources/images/intro-glass-' + idx + '.jpg)');
    ...
    $('.reinforce .glass-list').hover(function () {
        ...
        glassImg.attr('style', 'background-image:url(/en/resources/images/phone-' + idx + '.jpg)');
        ...
        glassImg.attr('style', ' background-image:url(/en/resources/images/product-' + idx + '.jpg)');
